...
public final class CommandLineSupport {
     ...
     * 
     * Notice the the proper conversion for the argument is determined by examining
     * the setter arguement type.
     * 
     * @param target
     *            the object that will have it's properties set
     * @param args
     *            the commline options
