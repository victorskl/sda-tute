 ...
 * Topics.
 */
public class PublisherBak implements MessageListener {
    ...
    public static void main(String[] argv) throws Exception {
        PublisherBak p = new PublisherBak();
        p.run();
    }
    ...
    private void run() throws Exception {
        ...
        MessageConsumer consumer = session.createConsumer(control);
